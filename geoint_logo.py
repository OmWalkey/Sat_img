...
def display_company_logo():
    ...
    try:
        ...
        logo = Image.open("company_logo.png")  # Replace with your logo file path
        ...
        <div style='display: flex; align-items: center; margin-bottom: 1rem;'>
            <div style='background: linear-gradient(45deg, #1f77b4, #ff7f0e); 
                        color: white; 
                        padding: 10px 20px; 
                        border-radius: 8px; 
                        margin-right: 20px;
            ...
            <div>
                <h1 style='margin: 0; color: #1f77b4;'>🛰️ GEOINT</h1>
                <p style='margin: 0; color: #666;'><strong>Advanced aerial image analysis</strong></p>
            </div>
        </div>
        """, unsafe_allow_html=True)
    except Exception as e:
        # Another fallback with simple text
        st.markdown("""
        <div style='text-align: center; padding: 1rem; border-bottom: 2px solid #1f77b4; margin-bottom: 1rem;'>
            <h3 style='color: #1f77b4; margin: 0;'>YOUR COMPANY NAME</h3>
            <h1 style='margin: 0.5rem 0;'>🛰️ GEOINT</h1>
            <p style='margin: 0; color: #666;'><strong>Advanced aerial image analysis</strong></p>
        </div>
        """, unsafe_allow_html=True)
...
<div style='text-align: center; color: #666; padding: 20px;'>
    <p style='font-size: 18px; font-weight: bold; color: #1f77b4; margin-bottom: 5px;'>GeoInt</p>
    <p style='margin: 0;'>Powered by <strong>YOUR COMPANY NAME</strong></p>
    <p style='font-size: 12px; margin-top: 5px;'>Advanced AI Solutions for Defense & Intelligence</p>
</div>
""", unsafe_allow_html=True)
